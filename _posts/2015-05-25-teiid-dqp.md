...
> NOTE: Phase 1 create a logical plan, Phase 2 update logical plan, Phase 2 convert logical plan to processor plan.
...
**2. EXECUTING RaiseAccess** - implementation class is `org.teiid.query.optimizer.relational.rules.RuleRaiseAccess`.
